...
exports.sendOtp = async (req, res) => {
    ...
    const options = {
        method: 'POST',
        url: `https://control.msg91.com/api/v5/otp?template_id=65ce0071d6fc0527d10a0e62&mobile=${req.body.number}`,
        headers: {
...
exports.verifyOtp = async (req, res) => {
    ...
    axios
        ...
        .then(async function (response) {
            ...
            const saveMobile = await otpverify.create({ mobile: mobile })
            if (saveMobile) {
                res.status(200).json(response.data)
            }
        })
